...
@SourceType(value = "ODataARP", label = "OData",uiConfig = "odata-layout.json")
public class ODataConf extends AbstractArpConf<ODataConf> {
  private static final String ARP_FILENAME = "arp/implementation/odata-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.odata.ODataDriver";
